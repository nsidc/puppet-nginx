...
describe 'nginx::resource::location' do
  ...
  describe 'os-independent items' do
    describe 'basic assumptions' do
      ...
      it { is_expected.to contain_concat__fragment('vhost1-500-33c6aa94600c830ad2d316bb4db36724').with_content(%r{location rspec-test}) }
